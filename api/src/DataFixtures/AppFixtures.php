...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $component->setLongDescription('Het Queue Component bevat een lijst van later uit te voeren taken, dat wil zeggen in dit component kunnen taken worden aangemaakt die door andere componenten op een later tijdstip moeten worden uitgevoerd. Dit lijkt op het versturen van notificaties met een paar afwijkingen:<br><br> De notificatie gaat altijd terug naar de indienende applicatie.<br><br> De notificatie wordt op een later moment verzonden.<br><br> De notificatie bevat een unieke id waarop de kan worden overschreven.<br><br> Deze logica wordt gebruik om cronjobs en het analyseren van de database te voorkomen, voorbeeld: stel een gebruiker plaatst een bestelling en heeft de mogelijkheid om later te betalen, maar doet de gebruiker dit niet, dan wordt de bestelling na 30 dagen geannuleerd. Als we dit willen oplossen met een cronjob zouden we iedere dag een data bevraging moeten doen van alle bestellingen die aan de criteria voldoen en deze annuleren.<br><br> Dat heeft een aantal nadelen:<br><br> We moeten altijd een hele database analyseren, ook al hebben we maar één order nodig.<br><br> We zijn op de dag nauwkeurig i.p.v. van op de minuut (en als we op de minuut nauwkeurig zouden willen zijn, moeten we iedere minuut de hele database bevragen).<br><br> Een toename van business logica, voorwaarde en gevolgen (willen we bijvoorbeeld 5 dagen van te voren een herinneringsmail sturen?) leidt tot een scherpe toename van database bevragingen.<br><br> Om dit te voorkomen willen we graag een gerichte vraag stellen die één keer na 30 dagen afgaat, deze vraag kunnen we aanmaken als de order wordt geplaatst, omdat in de tussentijd containers kunnen wisselen en we centraal beheer willen kunnen doen op deze wachtrij, brengen we de vragen gebundeld onder in een apart component. Dit is het Queue Component.<br><br> Uitgangspunt hierbij is dat de queue andere componenten gericht notificeert (met de informatie waarmee specifiek kan worden gehandeld, bijvoorbeeld een order id), maar dat de afhandelende applicatie zelf controleert of de handeling nog nodig is als onderdeel van de uitvoering (oftewel is de order nog onbetaald).<br><br> Op deze manier blijft de wachtrij verschoont van business logica, gecombineerd met het Processen Component (PC) biedt het echter de optie om microservices en BPMN processen in de wachtrij te zetten, waarbij het natuurlijk technisch mogelijk is om de uitvoering met 0 minuten te vertragen. Het maakt het mogelijk om processen asynchroon uit te voeren.');
        ...
        $component->setLongDescription('Het User Component voert het beheer over gebruikersaccount en hun autorisaties. Hierbij kan in de traditionele zin worden gedacht aan een gebruik die behoort tot bepaalde groepen die op hun beurt weer beschikken over bepaalde rechten. Waarbij het component tevens het bijhouden en valideren van wachtwoorden ondersteunt (ten einde inlog mogelijkheden op bijvoorbeeld een dashboard of applicatie te faciliteren) maar in de wat abstracte context ondersteund het ook algemene inlog systematieken.<br><br> Zo kan het User Component zelf functioneren als OAuth (2) bron en daarmee de bronhouder zijn voor een OpenID van een gebruike,r maar kan het ook alternatieve inlog stromen zoals AFC en SAML afhandelen (en daarmee DigiD). Als laatste kan het functioneren als ontvangende partij van OAuth inloggen en biedt het daarmee een inloggen met Facebook, Google of GitHub mogelijkheid voor applicaties.');
        ...
        $component->setLongDescription('Het Order Registratie Component verzorgt de afhandeling van bestellingen met uitzondering van facturatie en betalingen. Het biedt in samenwerking met het PDC een multi-tenant en omnichannel oplossing voor het verkopen van producten en diensten. Hierbij worden offers (te kopen resources vanuit het PC) toegevoegd aan een order, waarbij het Order Registratie Component de geldigheid van de aanbieding controleert en een eventuele prijs en betaling berekeningen uitvoert.<br><br> Omdat orders ook de status “basket” kunnen hebben, neemt het component hierbij essentiële validatie van de frontend over, waardoor ontwikkelaars worden ontlast en organisaties verzekerd worden van een propere berekening.<br><br> In tandem met het VRC voorziet het order component ook in de directe afhandeling van een order. Voor een simpele bestelling kan er hierbij worden gedacht aan een orderpick proces, maar voor complexe bestellingen kunnen ook zaken of processen worden opgestart.');
        ...
        $component->setShortDescription('Het Betalen Component handelt, bij voorkeur in samenwerking met het Order Registratie Component, betalingen af. Hiervoor maakt het facturen aan en meldt deze (indien gewenst) bij een payment provider aan. Als laatste worden de resultaten van de payment provider verwerkt, waarmee een invoice overzicht wordt gecreëerd dat kan worden gebruikt door zowel organisaties als klanten. <br><br> Indien gewenst kan het Betalen Component in samenwerking met het WRC (sjablonen), BS (mail en sms) en het Queue Component worden ingezet voor de opvolging van betalingen in de trant van herinneringen en aanmaningen.');
        ...
        $component->setShortDescription('Het Instemmingen Registratie Component heeft als doel om instemmingen vast te leggen ten opzichte van resources. Hierbij wordt de instemming verleend door een rechtspersoon.<br> Instemmingen kunnen zowel specifiek zijn (dit verzoek mag namens mij worden ingediend), rol gebonden (ik ga er mee akkoord getuige voor dit huwelijk te zijn), als generiek. Generieke instemmingen worden afgegeven aan een (rechts)persoon ten opzichte van een verzoektype (deze persoon mag namens mij meldingen openbare ruimte doen). <br><br> Instemmingen fungeren hiermee zowel als een digitale handtekening, als mandaat.');
        $component->setLongDescription('Het Instemmingen Registratie Component heeft als doel om instemmingen vast te leggen ten opzichte van resources. Hierbij wordt de instemming verleend door een rechtspersoon.<br> Instemmingen kunnen zowel specifiek zijn (dit verzoek mag namens mij worden ingediend), rol gebonden (ik ga er mee akkoord getuige voor dit huwelijk te zijn), als generiek. Generieke instemmingen worden afgegeven aan een (rechts)persoon ten opzichte van een verzoektype (deze persoon mag namens mij meldingen openbare ruimte doen). <br><br> Instemmingen fungeren hiermee zowel als een digitale handtekening, als mandaat.');
        ...
        $component->setLongDescription('Het Contacten Component bevat lijsten van contactpersonen, hiermee heeft het vanuit bron perspectief doorgaans een aanvullende of vervangende taak ten opzichte van het BRP. Met andere woorden in het Contacten Component vinden we personen die we niet uit het BRP halen. Dat kan zijn, omdat deze personen niet in het BRP staan, we nog niet weten wat het BSN van een persoon is of omdat we simpelweg geen rechten of toegang hebben tot het BRP vanuit het proces waar we mee bezig zijn.<br><br> Daarnaast fungeert het Contacten Component als een Common Ground variant van de contactpersonenlijst, zoals we die kennen vanuit een e-mail applicatie of telefoon. Het is dus ook mogelijk om personen op te nemen in een contactenlijst. Hiermee worden contact en functionaliteiten voor gebruikers (in application form) gerealiseerd.<br><br> Als laatste biedt het Contacten Component de mogelijkheid om gegevens van organisaties op te slaan. Het component ondersteunt bewust alleen de persoonsgegevens, maar kan in samenwerking met het CMR en ORC een Customer Relation Management systeem vormen, waarbij het ORC de mogelijkheid biedt om bijvoorbeeld leads in kaart te brengen. ');
        ...
        $component->setShortDescription('Het export Component heeft als doel om data binnen Common Ground beschikbaar te maken als non-API data. Bijvoorbeeld als een Excel- of CSV- lijst.<br><br> In samenhang met het Queue Component voor geautomatiseerde taken en het WRC voor sjablonen, kan dit bijvoorbeeld worden gebruikt voor het draaien en versturen van een dagelijkse rapportage.');
        ...
        $component->setShortDescription('De Producten en Diensten Catalogus heeft als doel het geheel aan af te nemen producten en/of diensten in kaart te brengen. Hierbij wordt uitgegaan van afname door klanten vanuit een organisatie, maar er is geen technische beperking om het ook als inkoopsysteem te gebruiken.<br><br> Naast producten en diensten kent het component ook ondersteuning voor het maken van productgroepen, beschrijvende teksten, afbeeldingen, belastingen en andere zaken die specifiek gerelateerd zijn aan webshop concepten. Hierbij wordt (vanuit internationale normen) een onderscheid gemaakt tussen het product en het aanbieden van het product (offer) waarbij het mogelijk is om een aanbod te koppelen aan geldigheid of doelgroepen. Met andere woorden het is mogelijk om een product op bepaalde momenten goedkoper of juist duurder aan te bieden (trouwen in het weekend) of goedkoper aan te bieden voor bepaalde doelgroepen (korting op evenementen vergunningen voor buurtcomités).');
        $component->setLongDescription('De Producten en Diensten Catalogus heeft als doel het geheel aan af te nemen producten en/of diensten in kaart te brengen. Hierbij wordt uitgegaan van afname door klanten vanuit een organisatie, maar er is geen technische beperking om het ook als inkoopsysteem te gebruiken.<br><br> Naast producten en diensten kent het component ook ondersteuning voor het maken van productgroepen, beschrijvende teksten, afbeeldingen, belastingen en andere zaken die specifiek gerelateerd zijn aan webshop concepten. Hierbij wordt (vanuit internationale normen) een onderscheid gemaakt tussen het product en het aanbieden van het product (offer) waarbij het mogelijk is om een aanbod te koppelen aan geldigheid of doelgroepen. Met andere woorden het is mogelijk om een product op bepaalde momenten goedkoper of juist duurder aan te bieden (trouwen in het weekend) of goedkoper aan te bieden voor bepaalde doelgroepen (korting op evenementen vergunningen voor buurtcomités).');
        ...
        $component->setShortDescription('De Proto Applicatie levert een vooringerichte versie van het Symfony PHP framework, waarbij de NL Design System componenten zijn voorzien van template widgets. Oftewel het is mogelijk om vanuit je PHP/HTML templates direct gebruik te maken van NL Design Elementen. De business logica van de Proto Applicatie wordt geleverd door de generieke Common Ground Bundle. <br><br>Framework<br> De Proto Applicatie rust op het PHP Symfony Framework, daarbij importeert het de Common Ground Bundle, die het component als logica gebruikt (voor o.a. de VSBE) en NL Design System voor grafische vormgeving. Er is dus geen sprake van specifiek geschreven code, de applicatie wordt geheel vormgegeven door slim gebruik van dependency management en een klein beetje configuratie met betrekking tot hoe de applicatie zich authenticeert op Common Ground / NLX.<br><br> Het dient dus als een voorbeeld voor de kracht van framework development en dependency management als methodiek, om een volledige applicatie puur te baseren op hergebruik van code en processen.<br><br> NL Design System<br> Tevens is er een widget library beschikbaar voor de Processen Catalogus, dat wil versimpeld zeggen dat er vooringerichte widgets zijn die zijn gekoppeld aan een specifieke (micro) service. Hiermee worden de grafische elementen uit NL Design System geoperationaliseerd.<br><br> Voorbeelden hiervan zijn formulier-elementen zoals: ‘adres opgeven’, die gebruik maakt van de Adressen Service, om aan de hand van een huisnummer en postcode combinatie tot een BAG id te komen. En ‘bedrijf opgeven’, die aan de hand van een bedrijfsnaam een KVK-nummer suggereert. De Proto Applicatie geeft dus een invulling aan het verbinden van de door NL Design ontworpen UI en de door Common Ground Bundle geleverde componenten en API’s.<br><br> Very Small Business Engine<br> Onderdeel van de Proto Applicatie is de very small business engine, deze is oorspronkelijk bedacht voor het uitvoeren van simpele processen, maar heeft zich tegenwoordig gespecialiseerd in het ondersteunen van klantreizen. In de Common Ground zin wil dit dus zeggen dat het het Procestypen uit het PTC voorziet van de grafische elementen uit NL Design System (met indien nodig microservices uit het PC) en de resultaten van de klantreis als verzoek opslaat in het VRC. Met andere woorden de Proto Applicatie ondersteunt ‘out of the box’ klantreizen zoals gedefinieerd binnen Common Ground containers.<br><br> Implementaties<br> Er zijn momenteel een aantal voorbeeld implementaties van de Proto Applicatie beschikbaar vanuit de Huwelijksplanner, AdreswijzigingNL, Begraafplaatsen Registratie, COVID-19 formulieren, ROC Flevoland en Processen.');
